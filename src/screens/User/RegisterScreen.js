  ...
  const postCodeStyle = {
    ...
    return (
        ...
        <View style={styles.form}>
            ...
            {isPwSame ? (
                <View>
                  <Text style={{marginBottom:10,fontSize: 10,marginLeft: 185,float: "left",color: "#1E4119",}}>
                    {"      "}
                    비밀번호가 일치합니다.
                  </Text>
                </View>
                ...
                <View>
                  <Text style={{marginBottom:10,fontSize: 10,marginLeft: 170,float: "left",color: "red",}}>
                    {"    "}
                    비밀번호가 일치하지않습니다.
                  </Text>
                </View>
